...
\textbf{Questão 1 (3.11):} Suponha que temos um sistema de representação de ponto flutuante com base 2 e,  
\centerline{$x = \pm S \times 2^{E} $,}
\centerline{com $ S = (0.1b_2b_3b_4\dots b_{24})$,}
\centerline{i.e, $ \frac{1}{2} \leq S < 1$}
...
\begin{homeworkProblem}
\textbf{Questão 2 (5.1):} Qual é a representação do número $1/10$ no formato IEEE single para cada um dos quatro modos de arredondamento?
\begin{proof}[Resposta]
A resposta curta é: 
$$x = 0.0\overline{0011}$$, 
$$\textrm{round\_down}(x) = \textrm{round\_towards\_zero}(x) = 1.10011001100110011001100 \times 2^{-4}$$ e 
$$\textrm{round\_up}(x) = \textrm{round\_to\_nearest}(x) = 1.10011001100110011001101 \times 2^{-4}$$. \\
